...
> Extracted from [https://atlassian.com](https://atlassian.com) using `npx brandmd`.
>
> Drop this file in your project root so Claude Code, Cursor, Gemini CLI, Codex, or Google Stitch can match Collaboration software for software, IT and business teams's brand when generating UI.
>
