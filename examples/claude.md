...
> Extracted from [https://claude.com](https://claude.com) using `npx brandmd`.
>
> Drop this file in your project root so Claude Code, Cursor, Gemini CLI, Codex, or Google Stitch can match Claude's brand when generating UI.
>
