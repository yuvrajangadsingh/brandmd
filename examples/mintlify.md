...
> Extracted from [https://mintlify.com](https://mintlify.com) using `npx brandmd`.
>
> Drop this file in your project root so Claude Code, Cursor, Gemini CLI, Codex, or Google Stitch can match Mintlify - The Intelligent Knowledge Platform's brand when generating UI.
>
