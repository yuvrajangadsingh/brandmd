...
> Extracted from [https://shopify.com](https://shopify.com) using `npx brandmd`.
>
> Drop this file in your project root so Claude Code, Cursor, Gemini CLI, Codex, or Google Stitch can match Shopify: The All-in-One Commerce Platform for Businesses - Shopify's brand when generating UI.
>
