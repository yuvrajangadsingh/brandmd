...
> Extracted from [https://spotify.com](https://spotify.com) using `npx brandmd`.
>
> Drop this file in your project root so Claude Code, Cursor, Gemini CLI, Codex, or Google Stitch can match Spotify - Web Player: Music for everyone's brand when generating UI.
>
