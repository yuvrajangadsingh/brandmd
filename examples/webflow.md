...
> Extracted from [https://webflow.com](https://webflow.com) using `npx brandmd`.
>
> Drop this file in your project root so Claude Code, Cursor, Gemini CLI, Codex, or Google Stitch can match Webflow: The agentic web platform for modern businesses's brand when generating UI.
>
